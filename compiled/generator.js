(function () {
  var Grammar, KEYWORD_TRANSLATE, scopes, scope, try_block_stack, try_block_stacks, parfor_cb, parfor_cb_stack, callback_counter, current_callback, current_callbacks, comments, class_defs, class_def, literate, for_count, while_count, use_snippets, snippets;
  ...
  Grammar.Block.prototype.js = function () {
    var previous_cb, rv, statement, statement_js, ki$13, kobj$13;
    /*  
    ...
    for (ki$13 = 0; ki$13 < kobj$13.length; ki$13++) {
      ...
      /*  
          ...
          */
      if (statement_js[0] === '\n' && (rv.slice(-2) === '\n\n' || rv.length === 0)) {
        rv += multi_indent(statement_js.slice(1), this.indent_level);
      } else {
        rv += multi_indent(statement_js, this.indent_level);
      }
      /*  
