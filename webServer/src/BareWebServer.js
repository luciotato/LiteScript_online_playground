...
//## Helper Classes declaring node's 'http' module structures
   ...
   //constructor
   function Request(){//default constructor: call super.constructor
   ...
   //Request (extends|proto is) http.IncomingMessage
   ...
   //constructor
   function Response(){//default constructor: call super.constructor
       http.ServerResponse.prototype.constructor.apply(this,arguments)
   };
   //Response (extends|proto is) http.ServerResponse
