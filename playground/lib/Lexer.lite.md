...
#### Constructor new Lexer(compiler)
...
compile the body
            ...
            declare valid .compiler.activeOptions.browser
            var moduleNode = .compiler.compileModule(
                                referenceName
                                bodyLines, {
                                    browser: .compiler.activeOptions.browser
                                    target:'js' 
                                    verbose:0
...
Initialize output array
        ...
        if type of window is 'undefined' #in node
            import SourceMap
